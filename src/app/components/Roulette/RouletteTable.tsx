...
@observer
export class RouletteTable extends React.Component<IRouletteTable> {
            ...
            <tr className="roulette__table__row">
              <td
                ...
                className={cn(
                  ...
                  {
                    roulette__table__cell_selected: this.hasBet(0),
                  },
                )}
              >
                <span className="roulette__table__ball roulette__table__ball_green">0</span>
              </td>
                ...
                >
                  <span
                    className={cn('roulette__table__ball', {
                      roulette__table__ball_red: RED_SECTORS.indexOf(sector) >= 0,
                    })}
                  >
                    {sector}
                  </span>
              ...
              <td
                className={cn(
                  'roulette__table__cell roulette__table__cell_label roulette__table_radius-rt roulette__table_radius-rt roulette__table-last-col',
                  { roulette__table__cell_selected: this.hasBetByAlias(Alias.col3) },
                )}
              >
                {i18n.t('roulette_table_col3')}
              </td>
            </tr>
            <tr className="roulette__table__row">
